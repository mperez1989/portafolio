...
const HomePage = () => {
  return (
    <div className="home__container dark:bg-neutral-900">
      ...
      <button className="home__curriculum"><Link to='https://drive.google.com/file/d/1k41QYz30COWpw64CrmkL7Y4OiZYRwniM/view?usp=sharing' target="_blank">CV</Link></button>
